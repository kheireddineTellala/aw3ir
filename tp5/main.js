    ...
    app = new Vue({
        ...
        methods: {
            ...
            meteo: function(_city) {
                ...
                this.clearMsg();
                console.log('erreur form' + app.messageForm);

                // A compléter dans la suite du TP 
                this.cityWeatherLoading = true;

                // appel AJAX avec fetch
                fetch('https://api.openweathermap.org/data/2.5/weather?q=' + _city.name + '&units=metric&lang=fr&apikey=f8ac471ca5a6f05ab0a39facdfde6265')
                    ...
                    .then(function(json) {
                        ...
                        if (json.cod === 200) {
                            ...
                            // app.messageForm = '';
                            app.message = ' la cité  ' + _city.name + ' a été retrouvé';
                            console.log('erreur' + app.messageForm);
                            console.log('success' + app.message);
                        } else {
                            app.cityWeather = null;
                            // app.message='';
                            app.messageForm = 'Météo introuvable pour ' + _city.name +
                                ' (' + json.message + ')';
                            console.log('erreur' + app.messageForm);
                            console.log('success' + app.message);
                        }
